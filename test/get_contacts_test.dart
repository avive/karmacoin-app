      ...
      kc2Service.newUserCallback = (tx) async {
        ...
        switch (counter) {
          ...
          case 4:
            ...
            expect(contacts.any((contact) => contact.userName == tomUserName),
                isTrue);
            expect(contacts.any((contact) => contact.userName == tomasUserName),
                isTrue);
            expect(contacts.any((contact) => contact.userName == torUserName),
                isTrue);
            expect(
                contacts.any((contacts) => contacts.userName == platonUserName),
                isFalse);
