...
void main() {
  ...
  GetIt.I.registerLazySingleton<K2ServiceInterface>(() => GetIt.I.get<KarmachainService>());
      ...
      'create a pool works',
        () async {
          ...
          kc2Service.createCallback = (tx) async {
            ...
            final pool = pools.firstWhere((pool) => pool.roles.depositor == katya.accountId);
    ...
    test(
        'set commission for the pool works',
          ...
          kc2Service.createCallback = (tx) async {
            ...
            txHash = await kc2Service.setCommission(poolId, 20000000, katya.accountId);
          };
    ...
    test(
        'set commission change rate for the pool works',
          ...
          kc2Service.createCallback = (tx) async {
            ...
            txHash = await kc2Service.setCommissionChangeRate(poolId, commissionChangeRate);
          };
