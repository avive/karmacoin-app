...
class KC2StakingBondExtraTxV1 extends KC2Tx {
  BigInt amount;

  static KC2StakingBondExtraTxV1 createStakingBondExtraTx(
    ...
    try {
      ...
      return KC2StakingBondExtraTxV1(
        amount: amount,
        args: args,
        signer: signer,
      ...
      debugPrint("Error processing bond extra tx: $e");
      rethrow;
    }
  }
