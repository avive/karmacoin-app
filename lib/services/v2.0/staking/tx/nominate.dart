...
class KC2StakingNominateTxV1 extends KC2Tx {
  List<String> targets;

  static KC2StakingNominateTxV1 createStakingNominateTx(
    ...
    try {
      final targets = args['targets']
          .map((e) => ss58.Codec(netId).encode(e.value.cast<int>()))
          .toList()
          .cast<String>();

      return KC2StakingNominateTxV1(
        targets: targets,
        args: args,
        signer: signer,
