...
class PoolMember {
  /// The unique identifier of the pool to which member belongs to.
  PoolId id;

  /// The number of points this member has in the bonded pool or in a sub pool if `Self::unbonding_era` is some.
  ///
