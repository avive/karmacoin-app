...
class UpdateUserTransactionV1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<MobileNumber>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mobileNumber',
        subBuilder: MobileNumber.create)
    ..aOM<VerifyNumberResponse>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'verifyNumberResponse',
        subBuilder: VerifyNumberResponse.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set verifyNumberResponse(VerifyNumberResponse v) {
    setField(3, v);
  }
...
class VerifyNumberResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        ...
        $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..e<VerifyNumberResult>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'result',
        $pb.PbFieldType.OE,
        defaultOrMaker: VerifyNumberResult.VERIFY_NUMBER_RESULT_NICKNAME_TAKEN,
        valueOf: VerifyNumberResult.valueOf,
        enumValues: VerifyNumberResult.values)
    ..aOM<AccountId>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory VerifyNumberResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VerifyNumberResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  VerifyNumberResponse clone() =>
      VerifyNumberResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  VerifyNumberResponse copyWith(void Function(VerifyNumberResponse) updates) =>
      super.copyWith((message) => updates(message as VerifyNumberResponse))
          as VerifyNumberResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VerifyNumberResponse create() => VerifyNumberResponse._();
  VerifyNumberResponse createEmptyInstance() => create();
  static $pb.PbList<VerifyNumberResponse> createRepeated() =>
      $pb.PbList<VerifyNumberResponse>();
  @$core.pragma('dart2js:noInline')
  static VerifyNumberResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VerifyNumberResponse>(create);
  ...
  @$pb.TagNumber(3)
  set result(VerifyNumberResult v) {
    setField(3, v);
  }
