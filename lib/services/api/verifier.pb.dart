...
class SendVerificationCodeRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set mobileNumber($core.String v) {
    $_setString(0, v);
  }
...
class SendVerificationCodeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'karma_coin.verifier'),
      createEmptyInstance: create)
    ..e<SendVerificationCodeResult>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'result',
        $pb.PbFieldType.OE,
        defaultOrMaker: SendVerificationCodeResult
            .SEND_VERIFICATION_CODE_RESULT_UNSPECIFIED,
        valueOf: SendVerificationCodeResult.valueOf,
        enumValues: SendVerificationCodeResult.values)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SendVerificationCodeResponse clone() =>
      SendVerificationCodeResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SendVerificationCodeResponse copyWith(
      ...
      super.copyWith(
          ...
          as SendVerificationCodeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<SendVerificationCodeResponse> createRepeated() =>
      $pb.PbList<SendVerificationCodeResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set result(SendVerificationCodeResult v) {
    setField(1, v);
  }
...
class VerifyNumberRequest extends $pb.GeneratedMessage {
  ...
  factory VerifyNumberRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VerifyNumberRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  VerifyNumberRequest copyWith(void Function(VerifyNumberRequest) updates) =>
      super.copyWith((message) => updates(message as VerifyNumberRequest))
          as VerifyNumberRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VerifyNumberRequest create() => VerifyNumberRequest._();
  VerifyNumberRequest createEmptyInstance() => create();
  static $pb.PbList<VerifyNumberRequest> createRepeated() =>
      $pb.PbList<VerifyNumberRequest>();
  @$core.pragma('dart2js:noInline')
  static VerifyNumberRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VerifyNumberRequest>(create);
...
class VerifyNumberResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set result(VerificationResult v) {
    setField(3, v);
  }
...
class UserVerificationData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set verifierAccountId($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(4)
  set phoneNumberHash($core.String v) {
    $_setString(3, v);
  }
...
class VerifyNumberRequestData extends $pb.GeneratedMessage {
  ...
  factory VerifyNumberRequestData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VerifyNumberRequestData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  VerifyNumberRequestData clone() =>
      VerifyNumberRequestData()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  VerifyNumberRequestData copyWith(
          void Function(VerifyNumberRequestData) updates) =>
      super.copyWith((message) => updates(message as VerifyNumberRequestData))
          as VerifyNumberRequestData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VerifyNumberRequestData create() => VerifyNumberRequestData._();
  VerifyNumberRequestData createEmptyInstance() => create();
  static $pb.PbList<VerifyNumberRequestData> createRepeated() =>
      $pb.PbList<VerifyNumberRequestData>();
  @$core.pragma('dart2js:noInline')
  static VerifyNumberRequestData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<VerifyNumberRequestData>(create);
  ...
  @$pb.TagNumber(7)
  set verificationSid($core.String v) {
    $_setString(6, v);
  }
