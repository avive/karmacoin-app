...
class AuthRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'karma_coin.auth'), createEmptyInstance: create)
...
class AuthResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'karma_coin.auth'), createEmptyInstance: create)
    ..e<AuthResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.OE, defaultOrMaker: AuthResult.AUTH_RESULT_USER_AUTHENTICATED, valueOf: AuthResult.valueOf, enumValues: AuthResult.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  AuthResult get result => $_getN(0);
  @$pb.TagNumber(1)
  set result(AuthResult v) { setField(1, v); }
  @$pb.TagNumber(1)
