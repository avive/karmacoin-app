...
class SendVerificationCodeResult extends $pb.ProtobufEnum {
  static const SendVerificationCodeResult
      SEND_VERIFICATION_CODE_RESULT_UNSPECIFIED = SendVerificationCodeResult._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SEND_VERIFICATION_CODE_RESULT_UNSPECIFIED');
  static const SendVerificationCodeResult SEND_VERIFICATION_CODE_RESULT_SENT =
      SendVerificationCodeResult._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SEND_VERIFICATION_CODE_RESULT_SENT');
  static const SendVerificationCodeResult SEND_VERIFICATION_CODE_RESULT_FAILED =
      SendVerificationCodeResult._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<SendVerificationCodeResult> values =
  ...
  static final $core.Map<$core.int, SendVerificationCodeResult> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static SendVerificationCodeResult? valueOf($core.int value) =>
      _byValue[value];
...
class VerificationResult extends $pb.ProtobufEnum {
  ...
  static const VerificationResult VERIFICATION_RESULT_FAILED =
      VerificationResult._(
          5,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
