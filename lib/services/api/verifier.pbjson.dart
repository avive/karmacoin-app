...
final $typed_data.Uint8List sendVerificationCodeResultDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List verificationResultDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sendVerificationCodeRequestDescriptor =
    $convert.base64Decode(
        'ChtTZW5kVmVyaWZpY2F0aW9uQ29kZVJlcXVlc3QSIwoNbW9iaWxlX251bWJlchgBIAEoCVIMbW9iaWxlTnVtYmVy');
...
const SendVerificationCodeResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.karma_coin.verifier.SendVerificationCodeResult',
      '10': 'result'
    },
...
final $typed_data.Uint8List sendVerificationCodeResponseDescriptor =
    $convert.base64Decode(
        'ChxTZW5kVmVyaWZpY2F0aW9uQ29kZVJlc3BvbnNlEkcKBnJlc3VsdBgBIAEoDjIvLmthcm1hX2NvaW4udmVyaWZpZXIuU2VuZFZlcmlmaWNhdGlvbkNvZGVSZXN1bHRSBnJlc3VsdBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSIwoNZXJyb3JfbWVzc2FnZRgDIAEoCVIMZXJyb3JNZXNzYWdl');
...
final $typed_data.Uint8List verifyNumberRequestDescriptor = $convert.base64Decode(
    'ChNWZXJpZnlOdW1iZXJSZXF1ZXN0EhIKBGRhdGEYASABKAxSBGRhdGESHAoJc2lnbmF0dXJlGAIgASgMUglzaWduYXR1cmU=');
...
const VerifyNumberResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.karma_coin.verifier.VerificationResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List verifyNumberResponseDescriptor = $convert.base64Decode(
    'ChRWZXJpZnlOdW1iZXJSZXNwb25zZRISCgRkYXRhGAEgASgMUgRkYXRhEj8KBnJlc3VsdBgDIAEoDjInLmthcm1hX2NvaW4udmVyaWZpZXIuVmVyaWZpY2F0aW9uUmVzdWx0UgZyZXN1bHQ=');
...
final $typed_data.Uint8List userVerificationDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List verifyNumberRequestDataDescriptor =
    $convert.base64Decode(
        '');
